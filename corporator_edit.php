...
<body>
    ...
    <?php 
		$id=$_GET['id'];
		$qCorp=mysql_query("select * from master_tab_corp where corp_id='$id'");
    ...
    <!--content will start here-->
    	<div id="content" class="span10">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Edit Corporator</a></li>
			</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Corporator</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="corporator_edit_save.php" method="POST" enctype="multipart/form-data">
						  <fieldset>
                          
                          	<div class="control-group">
								<label class="control-label" for="focusedInput">Name </label>
								<div class="controls">
								  <input class="input-xlarge focused" id="name" name="name" type="text" value="<?php echo $corpName; ?>" required="required">
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="phone" name="phone" type="text" value="<?php echo $corpPhone; ?>" required="required">
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="mobile" name="mobile" type="text" value="<?php echo $corpMobile; ?>" required="required">
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="email" name="email" type="email" value="<?php echo $corpEmail; ?>" required="required">
								</div>
							  </div>
                                  ...
                                  <?php
									...
									while($dept_r=mysql_fetch_array($qdept))
									{
										...
										for($i=0;$i<$dept_count;$i++)
										{
											...
											{
												?>
                                                <option value="<?php echo $dpid; ?>" selected="selected"><?php echo $dpname; ?></option>
                                                <?php
											}
											else{
												?>
