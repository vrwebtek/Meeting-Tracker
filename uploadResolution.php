    ...
    <!--content will start here-->
    	<div id="content" class="span10">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Upload Resolution</a></li>
			</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Upload Resolution</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="uploadResolution_save.php" method="POST" enctype="multipart/form-data">
						  <fieldset>
						  ...
						  ?>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" title="download leave letter" href="party_edit.php?id=<?php echo $corpID; ?>">
