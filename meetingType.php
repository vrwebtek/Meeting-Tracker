    ...
    <!--content will start here-->
    	<div id="content" class="span10">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Types of Meetings</a></li>
			</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add a type of meeting</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="meetingType_save.php" method="POST" enctype="multipart/form-data">
						  <fieldset>
                          
                          	<div class="control-group">
								<label class="control-label" for="focusedInput">Meeting Type </label>
								<div class="controls">
								  <input class="input-xlarge focused" id="type" name="type" type="text"  required="required">
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="code" name="code" type="text"  required="required">
								</div>
							  </div>
